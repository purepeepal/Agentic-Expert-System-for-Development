...
> (Not yet populated — the Handler Agent will infer this from the user/developer's first interaction and validate.)
...
1. (Not yet established — requires explicit user confirmation)
...
| Dimension | Standard |
|-----------|----------|
| *Awaiting inference from user's work* | |
...
- Dimensions are added or removed based on what matters for the specific initiative
